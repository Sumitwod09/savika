...
export default function CartPage() {
    ...
    if (items.length === 0) {
        return (
            <div className="min-h-screen bg-[#F9F4EE] flex items-center justify-center px-4">
                <div className="text-center max-w-md">
                    ...
                    <h2 className="text-3xl font-bold font-[var(--font-playfair)] text-[#2E2E2E] mb-3">Your cart is empty</h2>
    ...
    return (
        <div className="min-h-screen bg-[#F9F4EE]">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <h1 className="text-3xl font-bold font-[var(--font-playfair)] text-[#2E2E2E] mb-8">
                    Your Cart{' '}
                ...
                <div className="grid lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-2 space-y-4">
                        {items.map((item) => {
                            ...
                            return (
                                <div key={`${item.product_id}-${item.weight}`} className="bg-white rounded-2xl p-4 flex gap-4 shadow-sm">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <Link href={`/product/${item.product.slug}`} className="font-semibold text-[#2E2E2E] font-[var(--font-poppins)] hover:text-[#C47F17] block truncate">
                                            {item.product.name}
                                        </Link>
                                        ...
                                        <div className="flex items-center gap-3 mt-3">
                                            <div className="flex items-center border border-[#e8ddd0] rounded-lg overflow-hidden">
                                                ...
                                                <span className="px-3 py-1.5 text-sm font-bold text-[#2E2E2E] font-[var(--font-poppins)]">{item.quantity}</span>
                                                <button onClick={() => updateQuantity(item.product_id, item.quantity + 1)} className="px-3 py-1.5 text-[#C47F17] hover:bg-[#F9F4EE] transition-colors">
                    ...
                    <div className="space-y-4">
                        <div className="bg-white rounded-2xl p-6 shadow-sm">
                            <h3 className="font-bold font-[var(--font-playfair)] text-[#2E2E2E] text-lg mb-6">Order Summary</h3>
                            ...
                            <div className="flex gap-2 mb-6">
                                <div className="relative flex-1">
                                    ...
                                    <input type="text" value={coupon} onChange={(e) => setCoupon(e.target.value)}
                                        ...
                                        className="w-full pl-9 pr-3 py-2.5 rounded-xl border border-[#e8ddd0] bg-white text-sm font-[var(--font-poppins)] focus:outline-none focus:border-[#C47F17]" />
                                </div>
