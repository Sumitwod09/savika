...
export default function WhySavika() {
    return (
        <section className="bg-white dark:bg-[#141414] py-14 px-4">
            <div className="max-w-7xl mx-auto">

                {/* Header */}
                <div className="text-center mb-12">
                    <span className="inline-block bg-[#FFF0DC] dark:bg-[#2a1800] text-[#C47F17] text-xs font-bold px-4 py-1.5 rounded-full mb-4">
                        <i className="fa-solid fa-award mr-1" />OUR PROMISE
                    </span>
                    <h2 className="text-3xl font-extrabold text-[#2E2E2E] dark:text-white mb-3">
                        Quality That <span className="text-[#C47F17]">Loves</span> Your Kitchen Back
                        <i className="fa-solid fa-utensils ml-2 text-[#C47F17]" />
                    </h2>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
                    {reasons.map((r) => (
                        ...
                        >
                            ...
                            >
                                <i className={`fa-solid ${r.icon} text-2xl`} style={{ color: r.iconColor }} />
                            </div>
